...
setwd('c:/Users/karsten/Dropbox/Devel/CPTAC-LSCC2020/')

## import gct files
data.dir <- 'g:/Shared drives/CPTAC3.0_LSCC_Data/lscc-v3.2-data-freeze/'
label <- 'v3.2-tumor-over-nat'

ord.column <- 'NMF.cluster'


gct.str <- c(glue("{data.dir}lscc-v3.2-acetylome-ratio-norm-NArm.gct"),
             glue("{data.dir}lscc-v3.2-gene-level-cnv-gistic2-all_data_by_genes.gct"),
             glue("{data.dir}lscc-v3.2-phosphoproteome-ratio-norm-NArm.gct"),
             glue("{data.dir}lscc-v3.2-proteome-ratio-norm-NArm.gct"),
             glue("{data.dir}lscc-v3.2-rnaseq-uq-fpkm-log2-NArm-row-norm.gct")
             )
...
## export
save(column.anno, row.anno, tab.expr.all, file = glue('data/data-lscc-{label}.RData'))
